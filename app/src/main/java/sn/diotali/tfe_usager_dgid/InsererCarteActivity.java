...
public class InsererCarteActivity extends AppCompatActivity {
    private ImageView btn_retour, btn_carte;
    ImageView menu_bar;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_inserer_carte);
        ...
        menu_bar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PopupMenu popup = new PopupMenu(InsererCarteActivity.this, menu_bar);
        ...
        btn_carte = findViewById(R.id.btn_carte);

        btn_carte.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(InsererCarteActivity.this, InsererCodeActivity.class);
                startActivity(intent);
            }
        });
